...
BEGIN
  ...
  ('Centro Medico Santagostino MI', 'Poliambulatorio con oltre 60 specialità mediche e diagnostica completa. Servizio medico di qualità a prezzi accessibili, anche odontoiatria.', cat_salute, 'Piazza Sant''Agostino', '2', 'Milano', 'MI', '20123', '+39 02 8970 6001', 'milanob@santagostino.it', true, false),
...
BEGIN
  ...
  ('Bottega del Vino Verona', 'Enoteca e ristorante storico dal 1890 con oltre 2500 etichette. Cucina veronese tradizionale e carta vini eccezionale.', cat_ristoranti, 'Via Scudo di Francia', '3a', 'Verona', 'VR', '37121', '+39 045 8004535', 'info@bottegaviniverona.it', true, false),
