...
const faqs: FAQItem[] = [
  {
    ...
    answer: 'Clicca su "Registrati", scegli tra account Cliente o Business, inserisci email e password. Gli account Cliente hanno 1 mese di prova gratuita, poi partono da 0,49€/mese. Gli account Business partono da 2,49€/mese + IVA dopo la prova.'
  },
  {
    category: 'Iscrizione e Account',
  ...
  },
  {
    ...
    answer: 'Per Clienti: da 0,49€/mese (1 persona) a 1,49€/mese (4 persone). Per Business: da 2,49€/mese + IVA (1 sede) a tariffe personalizzate per 10+ sedi. Piani annuali con sconto fino al 30%. Tutti includono 1 mese di prova gratuita.'
  },
  {
    category: 'Abbonamenti',
    question: 'Come funziona la prova gratuita?',
    answer: 'Attiva 1 mese di prova gratuita senza carta di credito. Riceverai un promemoria 7 giorni prima della scadenza. Se non rinnovi, l\'abbonamento scade automaticamente senza addebiti.'
  },
  {
    category: 'Abbonamenti',
              ...
              <div className="space-y-8">
                <div className="bg-gradient-to-br from-blue-50 to-cyan-50 border-2 border-blue-200 p-8 rounded-xl">
                  ...
                  <div className="space-y-4 text-gray-700">
                      ...
                      <div className="bg-white p-6 rounded-lg border-2 border-blue-300 shadow-sm">
                        ...
                        <ul className="space-y-2 text-sm">
                          ...
                          <li className="mt-3 pt-3 border-t border-gray-200">
                            <span className="font-bold text-blue-600">Da 0,49€/mese</span> dopo 1 mese di prova gratuita
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <p className="text-lg">
                      <strong>Passo 4:</strong> Attiva la prova gratuita di 1 mese (nessuna carta richiesta)
                    </p>
                      ...
                      <div className="space-y-4 text-gray-700">
                        ...
                        <div className="bg-gradient-to-r from-yellow-100 to-orange-100 p-6 rounded-xl shadow-md border-2 border-yellow-300">
                          ...
                          <p className="leading-relaxed">
                            ...
                            <span className="font-semibold">Solidarietà (10%)</span> saranno a zero per il primo mese
              ...
              <div className="space-y-10">
                <div className="bg-white p-6 rounded-lg border-2 border-purple-300 shadow-sm max-w-lg">
                  ...
                  <ul className="space-y-2 text-sm">
                    ...
                    <li className="mt-3 pt-3 border-t border-gray-200">
                      <span className="font-bold text-purple-600">Da 2,49€/mese + IVA</span> dopo 1 mese di prova
                    </li>
                  </ul>
                </div>
