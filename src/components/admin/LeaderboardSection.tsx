        ...
        <div className="flex items-center justify-between flex-wrap gap-4 mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">{filtered.length} di {leaderboard.length} utenti (escluse aziende)</p>
            </div>
          </div>
        </div>
          ...
          <tbody className="bg-white divide-y divide-gray-100">
            {filtered.map((user, index) => (
              <tr
                ...
                className={`hover:bg-gray-50 transition-colors ${index < 3 ? 'bg-yellow-50/20' : ''}`}
              >
                {/* Rank */}
